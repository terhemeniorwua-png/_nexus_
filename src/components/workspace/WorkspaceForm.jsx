...
export default function WorkspaceForm({ open, onClose, onSubmit, title, submitLabel, fields = {} }) {
  ...
  }, [open, fields.name, fields.description]);
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <label className="block">
          ...
          <input
            ...
            placeholder={title === "New workspace" ? "Launchpad" : "Sprint 4"}
